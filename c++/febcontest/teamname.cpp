...
// Chef thinks that a good team name should consist of two words such that they 
// are not funny, but if we swap the first letters in them, the resulting
//  words are funny. Note that under the given constraints, this means that
//   a word is a non-empty string containing only lowercase English letters.
...
// number of ways to choose a good team name.
...
// Example case 2: There are no good team names because all funny words start
//  with 'g'.
