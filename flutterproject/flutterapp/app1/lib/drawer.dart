  ...
  Widget build(BuildContext context) {
    ...
    final drawerItems = ListView(
      children: <Widget>[
        ...
        ListTile(
          title: Text('About us'),
          // onTap: () => Navigator.of(context).push(aboutus()),
        
        
        onTap: () {
                // navigateToaboutus(context);
                navigateToSlimyCardExample(context);
              },
        ),
        ListTile(
...
// Future _NewPage(context) async {
//   Navigator.push(context, MaterialPageRoute(builder: (context) => MyRegPage()));
// }

Future navigateToSlimyCardExample(context) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => SlimyCardExample()));
  }